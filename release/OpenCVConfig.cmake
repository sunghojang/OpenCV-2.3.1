...
SET(OpenCV_INCLUDE_DIRS "/opencv2.3/OpenCV-2.3.1/release" "/opencv2.3/OpenCV-2.3.1/include" "/opencv2.3/OpenCV-2.3.1/include/opencv")
...
SET(OpenCV_LIB_DIR /opencv2.3/OpenCV-2.3.1/release/lib)
...
# ==============================================================
if(NOT "/opencv2.3/OpenCV-2.3.1" STREQUAL  "")
    foreach(__CVLIB ${OpenCV_LIB_COMPONENTS})
        # We only need the "core",... part here: "opencv_core" -> "core"
        STRING(REGEX REPLACE "opencv_(.*)" "\\1" __MODNAME ${__CVLIB})
        INCLUDE_DIRECTORIES("/opencv2.3/OpenCV-2.3.1/modules/${__MODNAME}/include")
    endforeach()
endif()
...
IF (NOT OpenCV_SHARED)
    ...
    LINK_DIRECTORIES("/opencv2.3/OpenCV-2.3.1/release/3rdparty/lib")
